...
import (
	...
	"github.com/cmczk/shortest-url/internal/lib/api/response"
	"github.com/cmczk/shortest-url/internal/lib/logger/sl"
	"github.com/cmczk/shortest-url/internal/lib/random"
...
func New(log *slog.Logger, urlSaver URLSaver) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := validator.New().Struct(req); err != nil {
			...
			render.JSON(w, r, err.(validator.ValidationErrors))
